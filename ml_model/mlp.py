...
x = load_sparse_csr("tfidf/train_top1000_t.npz")
x_test = load_sparse_csr("tfidf/train_top1000_t.npz")
...
# 全连接层
model.add(Dense(1024, input_shape=(14323,), activation='relu'))
# DropOut层
...
test_prob.to_csv('prob_mlp_top1000.csv',index=None)
...
test_pred[["id","class"]].to_csv('mlp_top1000.csv',index=None)